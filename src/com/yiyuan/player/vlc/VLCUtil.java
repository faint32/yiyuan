...
public class VLCUtil {
    ...
    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = YiYuanPlayerApplication.getAppResources().getAssets().open(assetName);
    ...
    public static String getValue(String string, int defaultId)
    {
        return (string != null && string.length() > 0) ?
                string : YiYuanPlayerApplication.getAppContext().getString(defaultId);
    }

    public static int convertPxToDp(int px) {
        WindowManager wm = (WindowManager)YiYuanPlayerApplication.getAppContext().
    ...
    public static int convertDpToPx(int dp) {
        return Math.round(
                ...
                YiYuanPlayerApplication.getAppResources().getDisplayMetrics())
                         );
    }
    ...
    public static boolean isPhone(){
        TelephonyManager manager = (TelephonyManager)YiYuanPlayerApplication.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String[] getCustomDirectories() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(YiYuanPlayerApplication.getAppContext());
    ...
    public static String[] getMediaDirectories() {
        ArrayList<String> list = new ArrayList<String>();
        list.addAll(Arrays.asList(VLCUtil.getStorageDirectories()));
        list.addAll(Arrays.asList(VLCUtil.getCustomDirectories()));
