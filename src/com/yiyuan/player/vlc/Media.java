...
public class Media implements Comparable<Media> {
    ...
    public Media(String URI, Boolean addToDb) {
        ...
        if (addToDb) {
            ...
            MediaDatabase db = MediaDatabase.getInstance(YiYuanPlayerApplication.getAppContext());
            db.addMedia(this);
        }
    }
    ...
    private void extractTrackInfo(TrackInfo[] tracks) {
        ...
        for (TrackInfo track : tracks) {
            if (track.Type == TrackInfo.TYPE_VIDEO) {
                ...
                mTitle = track.Title;
                mArtist = VLCUtil.getValue(track.Artist, R.string.unknown_artist);
                mAlbum = VLCUtil.getValue(track.Album, R.string.unknown_album);
                mGenre = VLCUtil.getValue(track.Genre, R.string.unknown_genre);
    ...
    public Media(Context context, String location, long time, long length, int type,
        ...
        mTitle = title;
        mArtist = VLCUtil.getValue(artist, R.string.unknown_artist);
        mGenre = VLCUtil.getValue(genre, R.string.unknown_genre);
        mAlbum = VLCUtil.getValue(album, R.string.unknown_album);
    ...
    public String getFileName() {
        if (mFilename == null) {
            mFilename = VLCUtil.URItoFileName(mLocation);
        }
        return mFilename;
    }
    ...
    public Bitmap getPicture() {
        ...
        if (mPicture == null) {
            ...
            if (picture == null) {
                 ...
                 */
                Context c = YiYuanPlayerApplication.getAppContext();
    ...
    public String getGenre() {
        if(mGenre == YiYuanPlayerApplication.getAppContext().getString(R.string.unknown_genre))
            return mGenre;
